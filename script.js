...
function getpoints() {player.points += Math.round(player.ppc.base * player.ppc.mult.totalmanual)}
function autoclick() {player.points += Math.round(player.ppc.base * player.ppc.mult.totalauto)}
